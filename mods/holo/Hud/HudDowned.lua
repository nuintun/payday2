Holo:clone(HUDPlayerDowned) 
if Holo.options.HoxHud_support then 	
...
function HUDPlayerDowned:on_downed( ... )
	self.old.on_downed(self, ...)
	if Holo.options.HealthNum and managers.hud._teammate_panels[managers.hud.PLAYER_PANEL].update then 
